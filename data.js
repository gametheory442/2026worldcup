...
// Updated April 2, 2026 — all 6 playoff spots confirmed:
//   Path A → Bosnia & Herzegovina (Group B)
//   Path B → Sweden              (Group F)
//   Path C → Türkiye             (Group D)
//   Path D → Czechia             (Group A)
//   IC Path 1 → DR Congo         (Group K)
//   IC Path 2 → Iraq             (Group I)
// =============================================================
...
const TOURNAMENT_DATA = {
  ...
  teams: {
    ...
    "Czechia":              { group: "A", flag: "🇨🇿", confederation: "UEFA" },

    "Canada":               { group: "B", flag: "🇨🇦", confederation: "CONCACAF", pot: 1, host: true },
    "Bosnia & Herzegovina": { group: "B", flag: "🇧🇦", confederation: "UEFA" },
    ...
    "Türkiye":              { group: "D", flag: "🇹🇷", confederation: "UEFA" },
    ...
    "Sweden":               { group: "F", flag: "🇸🇪", confederation: "UEFA" },
    ...
    "Iraq":                 { group: "I", flag: "🇮🇶", confederation: "AFC" },
    ...
    "DR Congo":             { group: "K", flag: "🇨🇩", confederation: "CAF" },
  ...
  groupMatches: [
    ...
    { id:"match_2",  matchNum:2,  group:"A", date:"2026-06-11", kickoffET:"10:00 PM", team1:"South Korea",          team2:"Czechia",              venue:"Zapopan",        matchday:1 },
    { id:"match_3",  matchNum:3,  group:"B", date:"2026-06-12", kickoffET:"3:00 PM",  team1:"Canada",               team2:"Bosnia & Herzegovina", venue:"Toronto",        matchday:1 },
    ...
    { id:"match_8",  matchNum:8,  group:"D", date:"2026-06-13", kickoffET:"12:00 AM", team1:"Australia",            team2:"Türkiye",              venue:"Vancouver",      matchday:1, nextDay:true },
    ...
    { id:"match_12", matchNum:12, group:"F", date:"2026-06-14", kickoffET:"10:00 PM", team1:"Sweden",               team2:"Tunisia",              venue:"Zapopan",        matchday:1 },
    ...
    { id:"match_18", matchNum:18, group:"I", date:"2026-06-16", kickoffET:"6:00 PM",  team1:"Iraq",                 team2:"Norway",               venue:"Foxborough",     matchday:1 },
    ...
    { id:"match_21", matchNum:21, group:"K", date:"2026-06-17", kickoffET:"1:00 PM",  team1:"Portugal",             team2:"DR Congo",             venue:"Houston",        matchday:1 },
    ...
    // MATCHDAY 2
    { id:"match_25", matchNum:25, group:"A", date:"2026-06-18", kickoffET:"12:00 PM", team1:"Czechia",              team2:"South Africa",         venue:"Atlanta",        matchday:2 },
    { id:"match_26", matchNum:26, group:"B", date:"2026-06-18", kickoffET:"3:00 PM",  team1:"Switzerland",          team2:"Bosnia & Herzegovina", venue:"Inglewood",      matchday:2 },
    ...
    { id:"match_29", matchNum:29, group:"D", date:"2026-06-19", kickoffET:"12:00 AM", team1:"Türkiye",              team2:"Paraguay",             venue:"Santa Clara",    matchday:2, nextDay:true },
    ...
    { id:"match_33", matchNum:33, group:"F", date:"2026-06-20", kickoffET:"1:00 PM",  team1:"Netherlands",          team2:"Sweden",               venue:"Houston",        matchday:2 },
    ...
    { id:"match_42", matchNum:42, group:"I", date:"2026-06-22", kickoffET:"5:00 PM",  team1:"France",               team2:"Iraq",                 venue:"Philadelphia",   matchday:2 },
    ...
    { id:"match_48", matchNum:48, group:"K", date:"2026-06-23", kickoffET:"10:00 PM", team1:"Colombia",             team2:"DR Congo",             venue:"Zapopan",        matchday:2 },
    ...
    { id:"match_50", matchNum:50, group:"B", date:"2026-06-24", kickoffET:"3:00 PM",  team1:"Bosnia & Herzegovina", team2:"Qatar",                venue:"Seattle",        matchday:3, simultaneous:true },
    ...
    { id:"match_53", matchNum:53, group:"A", date:"2026-06-24", kickoffET:"9:00 PM",  team1:"Czechia",              team2:"Mexico",               venue:"Mexico City",    matchday:3, simultaneous:true },
    ...
    { id:"match_57", matchNum:57, group:"F", date:"2026-06-25", kickoffET:"7:00 PM",  team1:"Japan",                team2:"Sweden",               venue:"Arlington",      matchday:3, simultaneous:true },
    ...
    { id:"match_59", matchNum:59, group:"D", date:"2026-06-25", kickoffET:"10:00 PM", team1:"Türkiye",              team2:"United States",        venue:"Inglewood",      matchday:3, simultaneous:true },
    ...
    { id:"match_62", matchNum:62, group:"I", date:"2026-06-26", kickoffET:"3:00 PM",  team1:"Senegal",              team2:"Iraq",                 venue:"Toronto",        matchday:3, simultaneous:true },
    ...
    { id:"match_70", matchNum:70, group:"K", date:"2026-06-27", kickoffET:"7:30 PM",  team1:"DR Congo",             team2:"Uzbekistan",           venue:"Atlanta",        matchday:3, simultaneous:true },
  ...
  knockoutMatches: [
    ...
    { id:"match_74",  matchNum:74,  round:"R32",   date:"2026-06-29", team1Desc:"1st Group E",     team2Desc:"Best 3rd A/B/C/D/F", venue:"Foxborough",     feedsMatch:"match_89" },
    { id:"match_75",  matchNum:75,  round:"R32",   date:"2026-06-29", team1Desc:"1st Group F",     team2Desc:"2nd Group C",         venue:"Monterrey",      feedsMatch:"match_90" },
    { id:"match_76",  matchNum:76,  round:"R32",   date:"2026-06-29", team1Desc:"1st Group C",     team2Desc:"2nd Group F",         venue:"Houston",        feedsMatch:"match_91" },
    { id:"match_77",  matchNum:77,  round:"R32",   date:"2026-06-30", team1Desc:"1st Group I",     team2Desc:"Best 3rd C/D/F/G/H", venue:"East Rutherford",feedsMatch:"match_89" },
    { id:"match_78",  matchNum:78,  round:"R32",   date:"2026-06-30", team1Desc:"2nd Group E",     team2Desc:"2nd Group I",         venue:"Arlington",      feedsMatch:"match_91" },
    { id:"match_79",  matchNum:79,  round:"R32",   date:"2026-06-30", team1Desc:"1st Group A",     team2Desc:"Best 3rd C/E/F/H/I", venue:"Mexico City",    feedsMatch:"match_92" },
    { id:"match_80",  matchNum:80,  round:"R32",   date:"2026-07-01", team1Desc:"1st Group L",     team2Desc:"Best 3rd E/H/I/J/K", venue:"Atlanta",        feedsMatch:"match_92" },
    { id:"match_81",  matchNum:81,  round:"R32",   date:"2026-07-01", team1Desc:"1st Group D",     team2Desc:"Best 3rd B/E/F/I/J", venue:"Santa Clara",    feedsMatch:"match_94" },
    { id:"match_82",  matchNum:82,  round:"R32",   date:"2026-07-01", team1Desc:"1st Group G",     team2Desc:"Best 3rd A/E/H/I/J", venue:"Seattle",        feedsMatch:"match_94" },
    { id:"match_83",  matchNum:83,  round:"R32",   date:"2026-07-02", team1Desc:"2nd Group K",     team2Desc:"2nd Group L",         venue:"Toronto",        feedsMatch:"match_93" },
    { id:"match_84",  matchNum:84,  round:"R32",   date:"2026-07-02", team1Desc:"1st Group H",     team2Desc:"2nd Group J",         venue:"Inglewood",      feedsMatch:"match_93" },
    { id:"match_85",  matchNum:85,  round:"R32",   date:"2026-07-02", team1Desc:"1st Group B",     team2Desc:"Best 3rd E/F/G/I/J", venue:"Vancouver",      feedsMatch:"match_96" },
    { id:"match_86",  matchNum:86,  round:"R32",   date:"2026-07-03", team1Desc:"1st Group J",     team2Desc:"2nd Group H",         venue:"Miami Gardens",  feedsMatch:"match_95" },
    { id:"match_87",  matchNum:87,  round:"R32",   date:"2026-07-03", team1Desc:"1st Group K",     team2Desc:"Best 3rd D/E/I/J/L", venue:"Kansas City",    feedsMatch:"match_96" },
    { id:"match_88",  matchNum:88,  round:"R32",   date:"2026-07-03", team1Desc:"2nd Group D",     team2Desc:"2nd Group G",         venue:"Arlington",      feedsMatch:"match_95" },

    // ROUND OF 16
    { id:"match_89",  matchNum:89,  round:"R16",   date:"2026-07-04", team1Desc:"W Match 74",      team2Desc:"W Match 77",          venue:"Philadelphia",   feedsMatch:"match_97" },
    { id:"match_90",  matchNum:90,  round:"R16",   date:"2026-07-04", team1Desc:"W Match 73",      team2Desc:"W Match 75",          venue:"Houston",        feedsMatch:"match_97" },
    { id:"match_91",  matchNum:91,  round:"R16",   date:"2026-07-05", team1Desc:"W Match 76",      team2Desc:"W Match 78",          venue:"East Rutherford",feedsMatch:"match_99" },
    { id:"match_92",  matchNum:92,  round:"R16",   date:"2026-07-05", team1Desc:"W Match 79",      team2Desc:"W Match 80",          venue:"Mexico City",    feedsMatch:"match_99" },
    { id:"match_93",  matchNum:93,  round:"R16",   date:"2026-07-06", team1Desc:"W Match 83",      team2Desc:"W Match 84",          venue:"Arlington",      feedsMatch:"match_98" },
    { id:"match_94",  matchNum:94,  round:"R16",   date:"2026-07-06", team1Desc:"W Match 81",      team2Desc:"W Match 82",          venue:"Seattle",        feedsMatch:"match_98" },
    { id:"match_95",  matchNum:95,  round:"R16",   date:"2026-07-07", team1Desc:"W Match 86",      team2Desc:"W Match 88",          venue:"Atlanta",        feedsMatch:"match_100" },
    { id:"match_96",  matchNum:96,  round:"R16",   date:"2026-07-07", team1Desc:"W Match 85",      team2Desc:"W Match 87",          venue:"Vancouver",      feedsMatch:"match_100" },
    ...
    { id:"match_98",  matchNum:98,  round:"QF",    date:"2026-07-10", team1Desc:"W Match 93",      team2Desc:"W Match 94",          venue:"Inglewood",      feedsMatch:"match_101" },
    { id:"match_99",  matchNum:99,  round:"QF",    date:"2026-07-11", team1Desc:"W Match 91",      team2Desc:"W Match 92",          venue:"Miami Gardens",  feedsMatch:"match_102" },
